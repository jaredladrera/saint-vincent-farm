    ...
    <div class="col-12 col-lg-4">
        <div class="card-panel text-center profile-card">
            <div class="profile-avatar-wrap">
                <img src="https://ui-avatars.com/api/?name=Admin+User&background=0B6B1C&color=fff&size=160"
                     alt="Avatar" class="profile-avatar" />
                <button class="avatar-change-btn" title="Change photo">
                    <i class="bi bi-camera"></i>
                </button>
            </div>
            <h6 class="profile-name mt-3 mb-1">Admin User</h6>
            <span class="profile-role-tag">Super Admin</span>
            <hr class="my-3" />
            <ul class="profile-meta-list">
                <li><i class="bi bi-envelope"></i> admin@adminkit.com</li>
                <li><i class="bi bi-telephone"></i> +63 912 345 6789</li>
                <li><i class="bi bi-geo-alt"></i> Batangas, Philippines</li>
                <li><i class="bi bi-calendar-check"></i> Joined April 2024</li>
            </ul>
        </div>
    </div>
                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control" value="admin@adminkit.com" />
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" value="Batangas, Philippines" />
                        </div>
                        <div class="col-12">
                            <label class="form-label">Bio</label>
                            <textarea class="form-control" rows="3">System administrator managing the AdminKit platform.</textarea>
                        </div>
